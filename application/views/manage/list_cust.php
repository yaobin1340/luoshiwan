...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="<?php site_url('manage/list_cust')?>" method="post">
		<div class="searchBar">
			<table class="searchContent" id="search_purchase_order">
				<tr>
					<td><label>客户姓名：</label><input type="text" size="16" name="name" value="<?php echo $name;?>" /></td>
				</tr>
			</table>
			<div class="subBar">
				<ul>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="<?php echo site_url('manage/add_cust')?>" target="navTab" rel="add_cust" title="新建"><span>新建</span></a></li>
		</ul>
	</div>
