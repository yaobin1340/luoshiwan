...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="<?php echo site_url('manage/add_production')?>" target="navTab" rel="add_production" title="新建"><span>新建</span></a></li>
			<li><a class="edit" href="<?php echo site_url('manage/edit_production/{id}')?>" target="navTab" rel="add_production" warn="请选择一条记录" title="查看"><span>查看</span></a></li>
			<li><a class="delete" href="<?php echo site_url('manage/delete_production')?>/{id}" target="ajaxTodo"  title="确定要作废？" warn="请选择一条记录"><span>作废</span></a></li>
		</ul>
	</div>
